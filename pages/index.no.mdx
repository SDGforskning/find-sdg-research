...
<div className="flex flex-col divide-y divide-slate-700">
  ...
  <Features>
    <Feature>
      <h2 className="text-center text-xl font-bold"><a href='/guide/definition'>Definisjon</a></h2>
    </Feature>
    <Feature>
      <h2 className="text-center text-xl font-bold"><a href='/guide/sustainable-development-goals'>Bærekraftsmålene</a></h2>
    </Feature>
  </Features>
</div>
