...
These pages contain search strings used to find academic publications related to certain [Sustainable development goals](https://sdgs.un.org/goals) on baerekraftsforskning.no. 
For the most updated version of the strings, see our [Github SDG strings repository](https://github.com/SDGforskning/sdg-strings).
