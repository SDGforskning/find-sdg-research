...
For the most updated strings and a notebook (ipynb) of the python script, see our [Github SDG strings repository](https://github.com/SDGforskning/sdg-strings).
