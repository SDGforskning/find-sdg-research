...
### What are "targets"?
Each of the SDGs consists of several more detailed targets. You can read more about these under [About the SDGs](/en/om/om-baerekraftsmalene). 
...
You can find information about this here: [Search string documentation](/en/sokestreng/introduksjon).
...
See [Methods and coverage](/en/om/om-tjenesten).
