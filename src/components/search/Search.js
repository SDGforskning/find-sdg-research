        ...
        <SearchLayout
              ...
              {locale === 'en' ? (
                <>
                  ...
                  <p className='mb-8 -mt-1 text-xs'>
                    <InfoIcon className='w-4 h-4 inline' /> <Link href="/en/hjelp/sokehjelp#scientific-nvi" target={'_blank'} rel={'noreferrer'}>What does this mean?</Link>
                  </p>
                  ...
                  />
                  <p className='mb-8 -mt-1 text-xs'>
                    <InfoIcon className='w-4 h-4 inline' /> <Link href="/en/hjelp/sokehjelp#sdg-and-sdg-targets" target={'_blank'} rel={'noreferrer'}>What does this mean?</Link>
                  </p>
                  <Facet
                ...
                <>
                  ...
                  />
                  <p className='mb-8 -mt-1 text-xs'>
                    <InfoIcon className='w-4 h-4 inline' /> <Link href="/hjelp/sokehjelp#vitenskapelig-nvi" target={'_blank'} rel={'noreferrer'}>Hva betyr dette?</Link>
                  </p>
                  ...
                  />
                  <p className='mb-8 -mt-1 text-xs'>
                    <InfoIcon className='w-4 h-4 inline' /> <Link href="/hjelp/sokehjelp#bærekraftsmål-og-delmål-filter" target={'_blank'} rel={'noreferrer'}>Hva betyr dette?</Link>
                  </p>
                  <Facet
          ...
          bodyContent={
            <div>
              ...
              <SearchResultsPanel locale={locale} />
            </div>
          }
          bodyFooter={
            <>
